...
//http://admin.spl.games/
const data = {
    'host':'http://admin.spl.games/',
    'firstName':'',
    'lastName':'',
    'rider':false,
    'accessToken':'',
...
const reducer = (state = data, action) => {
    switch (action.type) {
        ...
        case 'CHANGE_FIRSTUSER':
            return {
                ...state,
                firstName: action.point.name,
                firstUserId:action.point.id,
                firstUserRent:action.point.rent
            };
        default:
            return state;
    }
