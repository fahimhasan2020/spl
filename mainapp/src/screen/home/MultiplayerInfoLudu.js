...
export class MultiplayerInfoLudu extends Component {
    componentDidMount=()=>{
        ...
        return (
            <View>
                ...
                <Text style={{marginLeft:20,marginRight:20,textAlign:'center',fontWeight:'bold'}}>
                    Play multiplayer mode, use coins  and win 90% of the price. 
                </Text>
                ...
                <View >
                    <Text style={{marginTop:5}}>One by one</Text>    
                </View>
                <TouchableOpacity onPress={async()=>{
                   
                   this.props.navigation.navigate('MultiPlayerInfo',{gameTitle:this.props.route.params.gameTitle,
                    Link:'https://spl.games/ludo/',
                    pic:this.props.route.params.pic,
...
elevation: 24}}>
  ...
  Play
            ...
            {/* <View style={{flexDirection:'row',justifyContent:'space-between',marginLeft:20,marginTop:20,borderWidth:2,borderColor:'#e4e4e4',marginRight:30,borderRadius:10,elevation:10,backgroundColor:'white',padding:5}}>
                <View >
                    <Text style={{marginTop:5}}>Multiplayer </Text>    
                </View>
                <TouchableOpacity onPress={async()=>{
                  this.props.navigation.navigate('MultiPlayerInfo',{gameTitle:this.props.route.params.gameTitle,Link:'https://spl.games/ludos',pic:this.props.route.params.pic,road:'Ludus'})
                    }}  style={{margin:5}}>
                <LinearGradient colors={['#5a9216', '#85bb5c', '#8bc34a']} style={{padding:5,width:90,height:30,marginRight:20,alignItems:'center',borderRadius:10,shadowColor: "#000",
shadowOffset: {
	width: 0,
...
elevation: 24}}>
  ...
  Play
            ...
            {/* <View style={{flexDirection:'row',justifyContent:'space-between',marginLeft:20,marginTop:20,borderWidth:2,borderColor:'#e4e4e4',marginRight:30,borderRadius:10,elevation:10,backgroundColor:'white',padding:5}}>
                ...
                <TouchableOpacity onPress={async()=>{
                  this.props.navigation.navigate('MultiPlayerInfo',{gameTitle:this.props.route.params.gameTitle,Link:this.props.route.params.Link,pic:this.props.route.params.pic,road:this.props.route.params.road})
                    }}  style={{margin:5}}>
                <LinearGradient colors={['#5a9216', '#85bb5c', '#8bc34a']} style={{padding:5,width:90,height:30,marginRight:20,alignItems:'center',borderRadius:10,shadowColor: "#000",
shadowOffset: {
	width: 0,
...
export default connect(mapStateToProps, mapDispatchToProps)(MultiplayerInfoLudu)