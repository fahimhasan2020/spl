...
<head>
    ...
    <link rel="stylesheet" href="{{asset('games/ludu/main.css')}}">
<!--    <link rel="stylesheet" href="dice.css">-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="icon.png" type="{{asset('games/ludu/image/png')}}"/>
    <link
    rel="stylesheet"
...
<script src="{{asset('games/ludu/logic.js')}}"></script>
    </div>
</body>
</html>