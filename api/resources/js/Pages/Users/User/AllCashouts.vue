                    ...
                    <table class="table table-bordered table-dark" style="overflow-x: scroll">
                        ...
                        <tr v-for="permission in permissionOutput.data" :key="permission.id">
                            ...
                            <td style="vertical-align: middle">
                                <inertia-link  href="#" class="text-warning" data-toggle="tooltip" data-placement="top" title="Cashout" @click.prevent="holdAdmin(permission)">
...
<script>
    export default {
        ...
        methods: {
            ...
            holdAdmin(datas){
                this.$confirm("Are you sure to cashout from user?","Warning","warning").then(() => {
                     const data = {
                        trid:datas.id,
                        user:datas.user_id,
                        amount:datas.amount,
                    ...
                    this.$inertia.post('/admins/coinsout/user', data,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
                        only: [],
