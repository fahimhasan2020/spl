                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark" style="overflow-x: scroll">
                        ...
                        <tr v-for="permission in permissionOutput.data" :key="permission.id">
                            ...
                            <td style="vertical-align: middle">
                                <inertia-link  href="#" class="text-warning" data-toggle="tooltip" data-placement="top" title="Hold Admin" @click.prevent="holdAdmin(permission.id)">
...
<script>
    export default {
        ...
        methods: {
            ...
            holdAdmin(id){
                this.$confirm("Are you sure to hold this User?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/hold/user/'+id,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
                        only: [],
