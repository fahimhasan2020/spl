                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark">
                        ...
                        <tr v-for="permission in permissionOutput.data" :key="permission.id">
                            ...
                            <td style="vertical-align: middle">
                                <inertia-link href="#" class="text-warning" data-toggle="tooltip" data-placement="top" title="Un Hold Admin" @click.prevent="unholdAdmin(permission.id)">
...
<script>
    export default {
        ...
        methods: {
            ...
            unholdAdmin(id){
                this.$confirm("Are you sure to unhold this user?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/unhold/user/'+id,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
                        only: [],
