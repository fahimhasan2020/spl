                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark" style="overflow-x: scroll">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 150px;vertical-align: middle">User Id</th>
                            <th scope="col" style="width: 150px;vertical-align: middle">Amount</th>
                            <th scope="col" style="width: 150px;vertical-align: middle">Nogod account</th>
                            <th scope="col" style="width: 150px;vertical-align: middle">Binance account</th>
                        ...
                        <tr v-for="permission in permissionOutput.data" :key="permission.id">
                            ...
                            <td style="vertical-align: middle">{{permission.user_id}}</td>
                            <td style="vertical-align: middle">{{permission.amount}}</td>
                            <td style="vertical-align: middle">{{permission.nogod_account}}</td>
                             <td style="vertical-align: middle">{{permission.binance_account}}</td>
                            <td style="vertical-align: middle">
                                <inertia-link  href="#" class="text-warning" data-toggle="tooltip" data-placement="top" title="Save coins" @click.prevent="holdAdmin(permission)">
...
<script>
    export default {
        ...
        methods: {
            ...
            holdAdmin(datas){
                this.$confirm("Are you sure to coins in this user?","Warning","warning").then(() => {
                    const data = {
                        trid:datas.id,
                        user:datas.user_id,
                        amount:datas.amount,
                    ...
                    this.$inertia.post('/admins/coinsin/user', data,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
                        only: [],
            ...
            suspendAdmin(id){
                this.$confirm("Are you sure to suspend this admin?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/suspend/user/'+id,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
                        only: [],
